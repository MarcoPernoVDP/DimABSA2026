...
Let $P_{\text{cat}} \subseteq P$ denote the set of predictions in which all categorical elements (A, C, O) exactly match the gold annotation for the same sentence. The final semantic continuous recall and precision are:
