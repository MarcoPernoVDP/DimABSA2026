...
\begin{itemize}
    ...
    \item \textbf{Figure 2} (Section 4.1): Bar chart comparing cF1 scores using exact matching vs semantic matching for both pipelines. Four bars total: Pipeline 1 (exact: 30.51\%, semantic: 46.94\%) and Pipeline 2 (exact: 53.68\%, semantic: 63.37\%).
